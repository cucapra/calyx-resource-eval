...
func.func @main() {
  ...
  %0 = affine.load %alloca_1[0] : memref<40xi32>
  ...
  affine.store %1, %alloca_0[0] : memref<40xi32>
  affine.for %arg0 = 1 to 40 {
    ...
    affine.for %arg1 = 0 to #map(%arg0) {
      %12 = affine.load %alloca_1[%arg0 - %arg1 - 1] : memref<40xi32>
      %13 = affine.load %alloca_0[%arg1] : memref<40xi32>
      %14 = arith.muli %12, %13 : i32
      %15 = affine.load %alloca_2[] : memref<i32>
      %16 = arith.addi %15, %14 : i32
      affine.store %16, %alloca_2[] : memref<i32>
    }
    %7 = affine.load %alloca_1[%arg0] : memref<40xi32>
    ...
    affine.for %arg1 = 0 to #map(%arg0) {
      %12 = affine.load %alloca_0[%arg1] : memref<40xi32>
      %13 = affine.load %alloca_0[%arg0 - %arg1 - 1] : memref<40xi32>
      %14 = arith.muli %11, %13 : i32
      %15 = arith.addi %12, %14 : i32
      affine.store %15, %alloca[%arg1] : memref<40xi32>
    }
    affine.for %arg1 = 0 to #map(%arg0) {
      %12 = affine.load %alloca[%arg1] : memref<40xi32>
      affine.store %12, %alloca_0[%arg1] : memref<40xi32>
    }
    affine.store %11, %alloca_0[%arg0] : memref<40xi32>
  }
  return
}
