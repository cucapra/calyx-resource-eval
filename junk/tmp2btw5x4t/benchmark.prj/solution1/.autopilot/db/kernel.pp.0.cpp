...
# 3 "./kernel.cpp" 2
extern "C" {
  __attribute__((sdx_kernel("kernel", 0))) void kernel(ap_uint<32> A[8], ap_uint<32> B[8], ap_uint<32> v[1]) {_ssdm_SpecArrayDimSize(A, 8);_ssdm_SpecArrayDimSize(B, 8);_ssdm_SpecArrayDimSize(v, 1);
