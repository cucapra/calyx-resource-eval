...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("v_i", 32, hls_in, 2, "ap_ovld", "in_data", 1),
	Port_Property("v_o", 32, hls_out, 2, "ap_ovld", "out_data", 1),
	Port_Property("v_o_ap_vld", 1, hls_out, 2, "ap_ovld", "out_vld", 1),
