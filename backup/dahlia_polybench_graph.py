...
def futil_phases_cycles_graph(polybench, fig_fontsize, legend_fontsize):
  ...
  g.axes[0,0].axhline(gmean_sh_sc, color="black", linestyle="dashed", label="Geo Mean")
...
if __name__ == "__main__":
  ...
  polybench_raw = pd.concat([standard_hls, standard_futil, standard_futil_lat, sc_sh_futil, sc_sh_futil_lat])

  futil_phases_raw = pd.concat([sc_sh_futil, sc_sh_futil_lat, sc_futil, sc_futil_lat, sh_futil, sh_futil_lat, sh_sc_futil, sh_sc_futil_lat])
  ...
  futil_phases = cleanup(futil_phases_raw, {
      ('key', 'avg_latency'): 'latency',
      **polybench_rename
  ...
  futil_phases_cycles_graph(polybench=futil_phases, fig_fontsize=27, legend_fontsize=24)
  # futil_phases_resources_graph(polybench=futil_phases, fig_fontsize=27, legend_fontsize=24, resource='lut')
  # futil_phases_resources_graph(polybench=futil_phases, fig_fontsize=27, legend_fontsize=24, resource='registers')
