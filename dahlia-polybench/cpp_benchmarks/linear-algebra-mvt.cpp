...
/***************** Parse helpers  ******************/
/***************************************************/
void kernel(vector<unsigned int> &x1_int, vector<unsigned int> &x2_int,
            vector<unsigned int> &y1_int, vector<unsigned int> &y2_int,
...
int main(int argc, char **argv) {
  ...
  ;
  auto x1_int =
      get_arg<n_dim_vec_t<unsigned int, 1>>("x1_int", "ubit<32>[]", v);
  auto x2_int =
      get_arg<n_dim_vec_t<unsigned int, 1>>("x2_int", "ubit<32>[]", v);
  auto y1_int =
      get_arg<n_dim_vec_t<unsigned int, 1>>("y1_int", "ubit<32>[]", v);
  auto y2_int =
      get_arg<n_dim_vec_t<unsigned int, 1>>("y2_int", "ubit<32>[]", v);
  auto A_int =
