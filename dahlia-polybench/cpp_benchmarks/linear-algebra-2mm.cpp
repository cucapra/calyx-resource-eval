...
/***************** Parse helpers  ******************/
/***************************************************/
void kernel(vector<unsigned int> &alpha_int, vector<unsigned int> &beta_int, vector<vector<unsigned int>> &tmp_int, vector<vector<unsigned int>> &A_int, vector<vector<unsigned int>> &B_int, vector<vector<unsigned int>> &C_int, vector<vector<unsigned int>> &D_int) {
...
int main(int argc, char** argv) {
  ...
  auto tmp_int = get_arg<n_dim_vec_t<unsigned int, 2>>("tmp_int", "ubit<32>[][]", v);
