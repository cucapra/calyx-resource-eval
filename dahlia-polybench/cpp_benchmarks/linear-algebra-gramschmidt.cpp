...
void kernel(vector<vector<unsigned int>> &A_int,
            vector<vector<unsigned int>> &R_int,
            vector<vector<unsigned int>> &Q_int) {
...
int main(int argc, char **argv) {
  ...
  auto R_int =
      get_arg<n_dim_vec_t<unsigned int, 2>>("R_int", "ubit<32>[][]", v);
  auto Q_int =
      get_arg<n_dim_vec_t<unsigned int, 2>>("Q_int", "ubit<32>[][]", v);
