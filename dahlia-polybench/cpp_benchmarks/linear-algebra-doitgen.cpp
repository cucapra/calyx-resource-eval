...
/***************** Parse helpers  ******************/
/***************************************************/
void kernel(vector<vector<vector<unsigned int>>> &A_int,
            vector<vector<unsigned int>> &C4_int,
            vector<unsigned int> &sum_int) {
...
int main(int argc, char **argv) {
  ...
  ;
  auto A_int =
      get_arg<n_dim_vec_t<unsigned int, 3>>("A_int", "ubit<32>[][][]", v);
  auto C4_int =
      get_arg<n_dim_vec_t<unsigned int, 2>>("C4_int", "ubit<32>[][]", v);
  auto sum_int =
      get_arg<n_dim_vec_t<unsigned int, 1>>("sum_int", "ubit<32>[]", v);
